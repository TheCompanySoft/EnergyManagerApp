...
@end
@implementation EnergyChartListCell
...
-(void)getareaEnrgeyInfo:(EnergyConstuteInfo*)areaInfo{
    lable.text=areaInfo.energyname;
    lable1.text=areaInfo.energyunit;
    lable2.text=areaInfo.energyvalue;
    lable3.text=areaInfo.energysumcoalstandard;
